				...
				<div class="row">
					...
					<div class="col-md-5 col-xs-12">
						...
						<div class="ut-social pull-right">
							<a href="https://www.facebook.com/cubic.tc" class="social_facebook"></a> 
		...
		<div class="u-header">
			<div class="container">
				<div class="uh-logo pull-left">
					<h1><a href="index.html" title="Unique"><img src="images/logocubic.png" class="img-responsive" alt="Unique"/></a></h1>
				</div>
				...
				<nav class="collapse navbar-collapse" >
					...
					<ul id="headernavigation" class="nav navbar-nav pull-right">
						...
						<li class="menu-item-has-children">
							<a href="contact2.html" class="not-in-home">Contact Us</a> 
						</li>
					</ul>
					<!-- /.nav .navbar-nav -->
				</nav>
	...
	<div id="login-overlay" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">ZON ADMIN</h4>
          </div>
          <div class="modal-body">
              <div class="row">
                  <div class="col-xs-12">
                      <div class="well">
                          <form  action="admin_auth.php" autocomplete="on" type="POST"> <?php IF ($_REQUEST['n'] == 1) { ?> <font color="red"><i>Wrong Email and/or Password</i></font></center> <?php } ?>
	...
	<section class="calltoaction green_bg padding_top_thirty padding_bottom_thirty">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<a href="#" class="little_white btn-regular alignleft">purchase it now</a>
					<a href="#" class="little_white btn-regular alignleft">Contact Us Now</a>
				</div>
			</div>
		</div>
	</section>
